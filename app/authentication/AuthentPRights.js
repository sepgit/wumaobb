...
class AuthentPRights extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div>
        ...
        <article className="weui-article">
          ...
          <p>e.WMBB客服开设VIP通道为会员提供各种对接和咨询服务、以及法律、纠纷方面的咨询，认证会员可查看所有已认证公司和个人的信息；</p>
